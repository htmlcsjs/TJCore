...
public class TJRecipeMaps {
    ...
    public static final RecipeMap<SimpleRecipeBuilder> PRINTER_RECIPES = new RecipeMap<>("printer", 1, 4, 1, 2, 0, 0, 0, 0, new SimpleRecipeBuilder(), false).setSound(GTSounds.ASSEMBLER);
