...
public class LongDistanceNetHandler implements IEnergyContainer {
    private EnergyNetLongDistance net;
    private boolean transfer;
    private final TileEntityLongDistanceCable cable;
    private final EnumFacing facing;

    public LongDistanceNetHandler(EnergyNetLongDistance net, TileEntityLongDistanceCable cable, EnumFacing facing) {
        this.net = Objects.requireNonNull(net);
        this.cable = Objects.requireNonNull(cable);
        this.facing = facing;
    }

    public void updateNetwork(EnergyNetLongDistance net) {
        this.net = net;
    }

    public EnergyNetLongDistance getNet() {
        return net;
    }
    ...
    public long acceptEnergyFromNetwork(EnumFacing side, long voltage, long amperage) {
        ...
        System.out.println(net.getNetData(cable.getPos()));
        long amperesUsed = 0L;
