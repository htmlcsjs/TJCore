...
public class TJRecipeMaps {
    ...
    public static final RecipeMap<SimpleRecipeBuilder> COMPONENT_ASSEMBLER_RECIPES = new RecipeMap<>("component_assembler", 2, 6, 1, 1, 0, 3, 0, 0, new SimpleRecipeBuilder(), false).setSound(GTSoundEvents.ASSEMBLER);
    ...
    public static final RecipeMap<SimpleRecipeBuilder> STEAM_COMPONENT_ASSEMBLER_RECIPES = new RecipeMap<>("steam_assembler", 2, 6, 1, 1, 0, 0, 0, 0, new SimpleRecipeBuilder(), false).setSound(GTSoundEvents.ASSEMBLER);
    ...
    public static final RecipeMap<FuelRecipeBuilder> MODULAR_STEAM_TURBINE_RECIPES = new RecipeMap<>("modular_steam_turbine", 0, 0, 0, 0, 1, 1, 1, 1, new FuelRecipeBuilder(), false).setSound(GTSoundEvents.TURBINE).setProgressBar(GuiTextures.PROGRESS_BAR_GAS_COLLECTOR, ProgressWidget.MoveType.CIRCULAR).setSlotOverlay(false, true, true, GuiTextures.CENTRIFUGE_OVERLAY);
